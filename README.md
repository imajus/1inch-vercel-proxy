...
- Once the project is imported, you will need to change two settings before anything will work:
  ...
  - Second, go to `Settings`->`Deployment Protection`, disable `Vercel Authentication`, and press `Save`. This is critical for unauthenticated requests to reach the server
